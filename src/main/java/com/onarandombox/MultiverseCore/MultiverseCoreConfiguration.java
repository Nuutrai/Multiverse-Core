...
public class MultiverseCoreConfiguration extends SerializationConfig implements MultiverseCoreConfig {
    ...
    @Property
    private volatile boolean naturalrespawn;
    @Property
    private volatile int maxrespawntries;
    @Property
    private volatile int respawnxmin;
    @Property
    private volatile int respawnxmax;
    @Property
    private volatile int respawnzmin;
    @Property
    private volatile int respawnzmax;
    ...
    @Override
    public boolean isRtpEnabled() { return naturalrespawn; }
    @Override
    public int getMaxrtptries() { return maxrespawntries; }
    @Override
    public int getRtpxmin() { return respawnxmin; }
    @Override
    public int getRtpxmax() { return respawnxmax; }
    @Override
    public int getRtpzmin() { return respawnzmin; }
    @Override
    public int getRtpzmax() { return respawnzmax; }
